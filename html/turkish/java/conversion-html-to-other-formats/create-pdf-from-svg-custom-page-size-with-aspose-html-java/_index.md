...
category: general
date: 2026-03-22
description: Aspose.HTML for Java kullanarak özel sayfa boyutlu SVG'den PDF oluşturun
  – PDF sayfa boyutunu, kenar boşluklarını ayarlayın ve SVG'yi dakikalar içinde PDF'ye
  dönüştürün.
draft: false
keywords:
- create pdf from svg
...
- aspose html
language: tr
og_description: Aspose.HTML for Java kullanarak SVG'den özel sayfa boyutlu PDF oluşturun.
  PDF sayfa boyutunu, kenar boşluklarını nasıl ayarlayacağınızı ve SVG'yi birkaç adımda
  nasıl dönüştüreceğinizi öğrenin.
og_title: SVG'den PDF Oluştur – Aspose.HTML (Java) ile Özel Sayfa Boyutu
tags:
- java
- aspose
- pdf-generation
title: SVG'den PDF Oluştur – Aspose.HTML (Java) ile Özel Sayfa Boyutu
url: /tr/java/conversion-html-to-other-formats/create-pdf-from-svg-custom-page-size-with-aspose-html-java/
---
...
# SVG'den PDF Oluştur – Aspose.HTML (Java) ile Özel Sayfa Boyutu
