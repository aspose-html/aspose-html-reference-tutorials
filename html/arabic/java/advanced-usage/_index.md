...
### [تنفيذ JavaScript في Java باستخدام Aspose.HTML](./execute-javascript-in-java-using-aspose-html/)
تعلم كيفية تشغيل كود JavaScript داخل تطبيقات Java باستخدام Aspose.HTML.
