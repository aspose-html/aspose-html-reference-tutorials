...
### [在 C# 中的自定义资源处理程序 – 如何创建 HTML 的 ZIP](./custom-resource-handler-in-c-how-to-create-zip-of-html/)
使用 Aspose.HTML for .NET 在 C# 中创建自定义资源处理程序，将 HTML 内容压缩为 ZIP 文件的完整示例。
