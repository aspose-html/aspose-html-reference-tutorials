...
title: 使用 Aspose.HTML 将 HTML 转换为 PDF – 完整操作指南
url: /zh/
weight: 11
---
...
如果您需要 **将 HTML 转换为 PDF** 快速且可靠，您来对地方了。Aspose.HTML 为您提供强大的跨平台 API，不仅可以将 HTML 页面转换为完美的 PDF，还可以 **将 HTML 渲染为图像**、**从 HTML 生成 JPG**，甚至处理 EPUB 文件。在本指南中，我们将逐步演示 .NET 和 Java 最实用的教程，解释这些功能为何重要，并告诉您在哪里可以找到所需的完整代码。
...
- **额外格式** – 除了 PDF，您还可以 **将 HTML 渲染为图像**、**将 EPUB 转换为图像**，或 **从 HTML 生成 JPG**，只需一次调用。
...
查看 “HTML Extensions and Conversions” 部分——其中包含将 EPUB 包转换为 PDF 报告或一系列 PNG/JPG 页面 的逐步代码，涵盖 **convert epub to pdf** 与 **convert epub to image** 场景。
