...
### [แปลง EPUB เป็น PNG ใน Java – ตั้งค่าขนาดภาพ](./convert-epub-to-png-in-java-set-image-dimensions/)
เรียนรู้วิธีแปลงไฟล์ EPUB เป็น PNG พร้อมกำหนดความกว้างและความสูงของภาพโดยใช้ Aspose.HTML for Java  
