...
ก่อนแรกมาพูดถึงสตรีมหน่วยความจำกันก่อน ลองนึกภาพสตรีมหน่วยความจำเป็นพื้นที่จัดเก็บชั่วคราวที่เนื้อหา HTML ของคุณสามารถเก็บไว้ได้ก่อนที่จะหาที่อยู่ถาวรบนดิสก์ เหตุใดจึงเป็นประโยชน์? สตรีมหน่วยความจำนั้นรวดเร็วและมีประสิทธิภาพ ช่วยให้คุณสามารถจัดการข้อมูลได้โดยไม่ต้องเข้าถึงการดำเนินการอ่าน/เขียนที่ช้าของฮาร์ดไดรฟ์อยู่ตลอดเวลา
...
### [java fixed thread pool: นับรูปภาพในไฟล์แบบขนาน](./java-fixed-thread-pool-count-images-in-parallel-files/)
ใช้ java fixed thread pool เพื่อประมวลผลและนับจำนวนรูปภาพในหลายไฟล์พร้อมกันอย่างมีประสิทธิภาพ
