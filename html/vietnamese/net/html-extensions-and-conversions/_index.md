...
### [Chuyển đổi HTML sang PDF trong C# – thiết lập kiểu phông chữ bằng mã](./convert-html-to-pdf-in-c-set-font-style-programmatically/)
Thiết lập kiểu phông chữ khi chuyển đổi HTML sang PDF bằng C# và Aspose.HTML.
