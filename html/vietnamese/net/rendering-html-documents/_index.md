...
### [Cách bật khử răng cưa cho HTML‑to‑PDF trong C#](./how-to-enable-antialiasing-for-html-to-pdf-in-c/)
Tìm hiểu cách bật tính năng khử răng cưa khi chuyển đổi HTML sang PDF bằng Aspose.HTML cho .NET trong C#.
