...
### [HTML konvertálása ZIP-be C#‑ban – Teljes lépésről‑lépésre útmutató](./convert-html-to-zip-in-c-complete-step-by-step-guide/)
Lépésről‑lépésre útmutató a HTML fájl ZIP‑archívumba mentéséhez C#‑ban az Aspose.HTML for .NET használatával.
### [HTML konvertálása ZIP-be C#‑ban – Teljes útmutató](./convert-html-to-zip-in-c-complete-guide/)
Részletes, teljes körű útmutató a HTML ZIP‑archívumba mentéséhez C#‑ban az Aspose.HTML for .NET segítségével.
