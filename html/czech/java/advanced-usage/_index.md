...
### [Jak používat Executor v Javě – Průvodce pevného poolu vláken](./how-to-use-executor-in-java-fixed-thread-pool-guide/)
Naučte se, jak vytvořit a spravovat pevný pool vláken pomocí třídy ExecutorService v Javě.
