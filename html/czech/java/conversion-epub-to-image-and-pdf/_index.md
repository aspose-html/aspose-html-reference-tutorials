...
### [Převod EPUB na PNG v Javě – Nastavení rozměrů obrázku](./convert-epub-to-png-in-java-set-image-dimensions/)
Naučte se, jak převést EPUB na PNG a nastavit rozměry výstupních obrázků pomocí Aspose.HTML pro Java.
