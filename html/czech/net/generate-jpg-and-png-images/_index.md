...
### [Jak zakázat antialiasing při převodu HTML na PNG](./how-to-disable-antialiasing-when-converting-html-to-png/)
Naučte se, jak při převodu HTML na PNG zakázat antialiasing pro ostrý výstup.
