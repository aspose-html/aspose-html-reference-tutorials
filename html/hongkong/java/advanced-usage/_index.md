...
### [在 Java 中執行 JavaScript – 設定自訂 User-Agent（使用 Aspose.HTML）](./run-javascript-from-java-set-custom-user-agent-with-aspose-h/)
說明如何在 Aspose.HTML for Java 中執行 JavaScript 並自訂 HTTP User-Agent，以控制外部請求行為。
