...
### [在 Java 中執行 JavaScript – 從 HTML 執行 JS](./execute-javascript-in-java-run-js-from-html/)
說明如何在 Java 應用程式中載入 HTML 並執行其中的 JavaScript 程式碼，支援 Rhino、Nashorn 與 GraalVM。
