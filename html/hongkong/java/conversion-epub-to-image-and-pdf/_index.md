...
### [使用 Aspose.HTML for Java 將 EPUB 轉換為 PNG – 設定圖像尺寸](./convert-epub-to-png-in-java-set-image-dimensions/)
了解如何使用 Aspose.HTML for Java 在 Java 中將 EPUB 轉換為 PNG，並自訂圖像尺寸以符合需求。
