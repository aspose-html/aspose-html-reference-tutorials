...
### [Java에서 EPUB을 PNG로 변환하고 이미지 크기 설정](./convert-epub-to-png-in-java-set-image-dimensions/)
Aspose.HTML for Java를 사용해 EPUB을 PNG 이미지로 변환하면서 원하는 해상도와 크기를 설정하는 방법을 안내합니다.
