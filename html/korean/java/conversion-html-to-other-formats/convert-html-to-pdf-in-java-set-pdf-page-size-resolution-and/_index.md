...
category: general
date: 2026-09-03
description: Java에서 HTML을 PDF로 변환하면서 맞춤 page size, margins 및 resolution을 적용합니다. Aspose.HTML을
  사용하여 pdf page size를 설정하고 html을 pdf로 저장하는 방법을 배워보세요.
draft: false
keywords:
- set pdf page size
- html to pdf java
...
- set pdf resolution
lastmod: 2026-09-03
og_description: Aspose.HTML을 사용하여 Java에서 HTML을 PDF로 빠르게 변환하고 pdf page size를 설정합니다.
  page size, margins 및 resolution을 맞춤 설정하는 방법을 배워보세요.
...
- PDF
- Aspose.HTML
title: Java에서 HTML을 PDF로 변환 – pdf 페이지 크기 및 해상도 설정
---
...
# Java에서 HTML을 PDF로 변환 – PDF 페이지 크기 및 해상도 설정
...
![맞춤 옵션으로 HTML을 PDF로 변환](image.png "HTML을 PDF로 변환 예시")
[맞춤 옵션으로 HTML을 PDF로 변환](image.png "HTML을 PDF로 변환 예시")
...
## HTML을 PDF로 변환할 때 pdf 페이지 크기 설정 방법
...
#### 4. PDF 옵션 구성 – **set pdf page size** & **set pdf resolution**
...
**마지막 업데이트:** 2026-09-03  
**테스트 환경:** Aspose.HTML 23.10 for Java  
**작성자:** Aspose  
