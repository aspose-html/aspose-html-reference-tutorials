...
category: general
date: 2026-02-14
description: Aspose HTML을 사용하여 Java에서 HTML을 PDF로 변환하면서 PDF를 압축하는 방법을 배웁니다. 사용자 지정
  화면 설정 및 전체 코드 예제가 포함됩니다.
draft: false
keywords:
- how to compress pdf
- convert html to pdf
...
- set custom screen
language: ko
og_description: Aspose HTML을 사용하여 Java에서 HTML을 PDF로 변환하면서 PDF를 압축하는 방법. 사용자 지정 화면
  설정이 포함된 전체 단계별 튜토리얼.
og_title: Aspose HTML to PDF로 PDF 압축하는 방법 – Java 가이드
tags:
- Aspose
- Java
- PDF conversion
title: Aspose HTML to PDF로 PDF 압축하는 방법 – Java 가이드
...
# Aspose HTML to PDF를 사용한 PDF 압축 방법 – Java 가이드
