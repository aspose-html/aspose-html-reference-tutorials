...
### [HTML 제목 가져오기 Java – 화면 너비로 샌드박스에서 페이지 렌더링](./get-html-title-java-render-page-in-sandbox-with-screen-width/)
Aspose.HTML for Java를 사용해 샌드박스 환경에서 화면 너비를 지정해 HTML 페이지 제목을 추출하고 페이지를 렌더링하는 방법을 배웁니다.
