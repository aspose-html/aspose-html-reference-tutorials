...
### [Top-level await 예제 – JavaScript에서 await delay 사용](./top-level-await-example-using-await-delay-in-javascript/)
JavaScript에서 top-level await을 사용해 await delay를 구현하는 방법을 단계별로 배웁니다.
