...
### [Aspose를 사용해 SVG를 PNG로 변환할 때 DPI 설정하기 – Java 가이드](./how-to-set-dpi-when-converting-svg-to-png-with-aspose-java-g/)
Aspose.HTML for Java를 이용해 SVG 이미지를 PNG로 변환하면서 DPI를 지정하는 방법을 단계별로 안내합니다.
