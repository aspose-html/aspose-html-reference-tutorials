...
### [Aspose.HTML 샌드박스에서 DPI 설정 방법 – 완전한 Java 가이드](./how-to-set-dpi-in-aspose-html-sandbox-complete-java-guide/)
Aspose.HTML 샌드박스에서 DPI를 설정하여 PDF 출력 품질을 제어하는 방법을 단계별로 안내합니다.
