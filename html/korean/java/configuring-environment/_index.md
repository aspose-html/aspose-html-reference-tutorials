...
### [샌드박스 사용 방법 – 사용자 에이전트 설정 및 뷰포트 크기 가져오기](./how-to-use-sandbox-set-user-agent-get-viewport-size/)
Aspose.HTML for Java에서 샌드박스 내 사용자 에이전트를 지정하고 뷰포트 크기를 얻는 방법을 단계별로 배웁니다.
