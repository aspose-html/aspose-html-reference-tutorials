...
category: general
date: 2026-02-27
description: C#에서 사용자 정의 리소스 핸들러를 사용해 HTML을 ZIP으로 저장하고, C#으로 ZIP 아카이브를 생성합니다. HTML과
  해당 자산을 번들링하는 단계별 튜토리얼을 따라보세요.
draft: false
keywords:
- save html as zip
...
language: ko
og_description: 맞춤 리소스 핸들러를 사용해 C#에서 HTML을 ZIP으로 저장하세요. C#으로 ZIP 아카이브를 만드는 방법과 리소스를
  손쉽게 포함하는 방법을 배워보세요.
...
- C#
- ZIP
title: C#에서 HTML을 ZIP으로 저장하기 – 맞춤형 리소스 핸들러를 이용한 완전 가이드
url: /ko/net/working-with-html-documents/save-html-as-zip-in-c-complete-guide-with-custom-resource-ha/
---
...
# C#에서 HTML을 ZIP으로 저장 – 사용자 정의 리소스 핸들러 완전 가이드
...
![HTML을 ZIP으로 저장 예시](/images/save-html-as-zip.png "HTML이 ZIP 파일로 저장되는 다이어그램")

## Save HTML as ZIP – 이 가이드에서 다루는 내용
...
## Recap: 한 번에 HTML을 ZIP으로 저장하는 흐름
