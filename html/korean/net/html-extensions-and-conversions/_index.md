...
### [C#에서 HTML을 ZIP으로 압축하는 방법 – 커스텀 리소스 핸들러 가이드](./how-to-zip-html-in-c-custom-resource-handler-guide/)
C#와 Aspose.HTML을 사용해 커스텀 리소스 핸들러로 HTML을 ZIP 파일로 저장하는 단계별 가이드.
