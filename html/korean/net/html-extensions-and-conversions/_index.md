...
### [C#에서 사용자 정의 리소스 핸들러 – HTML을 ZIP으로 만들기](./custom-resource-handler-in-c-how-to-create-zip-of-html/)
C#와 Aspose.HTML을 사용해 HTML 파일을 ZIP 압축 파일로 저장하는 방법을 단계별로 안내합니다.
