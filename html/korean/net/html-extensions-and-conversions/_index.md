...
### [맞춤 리소스 핸들러 – C#에서 웹 페이지를 ZIP으로 변환](./custom-resource-handler-convert-webpage-to-zip-in-c/)
C#와 Aspose.HTML을 사용해 맞춤 리소스 핸들러로 웹 페이지를 ZIP 파일로 저장하는 방법을 단계별로 안내합니다.
