...
We’ll cover everything from parsing the file, locating the right `<path>` element, updating the colour, and finally writing the modified SVG back to disk. By the end you’ll have a reusable snippet you can drop into any project, and you’ll understand the “why” behind each step so you can adapt it to more complex SVG structures.
