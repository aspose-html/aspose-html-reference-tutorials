...
Apprenez à sauvegarder un document HTML dans une archive ZIP en C# avec Aspose.HTML.
### [Enregistrer le HTML en ZIP avec Aspose.HTML en C#](./save-html-as-zip-with-aspose-html-in-c/)
Apprenez à sauvegarder un document HTML dans une archive ZIP en C# avec Aspose.HTML.
