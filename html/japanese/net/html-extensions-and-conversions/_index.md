...
### [C# のカスタム リソース ハンドラ – HTML を ZIP に作成する方法](./custom-resource-handler-in-c-how-to-create-zip-of-html/)
Aspose.HTML を使用して、C# でカスタム リソース ハンドラを作成し、HTML コンテンツを ZIP アーカイブに圧縮する手順を解説します。
