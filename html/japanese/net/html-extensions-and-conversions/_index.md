...
### [C# で HTML を Zip に圧縮する方法 – カスタム リソース ハンドラ ガイド](./how-to-zip-html-in-c-custom-resource-handler-guide/)
C# と Aspose.HTML のカスタム リソース ハンドラを使用して、HTML を Zip に圧縮する手順を解説します。
