...
### [ZipHandler の使用方法 – C# でウェブページを ZIP アーカイブにする](./how-to-use-ziphandler-archive-webpage-as-zip-in-c/)
Aspose.HTML for .NET と ZipHandler を使用して、C# でウェブページを ZIP アーカイブに保存する手順を解説します。
