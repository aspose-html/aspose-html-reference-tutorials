...
category: general
date: 2026-04-01
description: Combine negrito e itálico em HTML usando C#. Aprenda como modificar o
  estilo da fonte em HTML, salvar o HTML modificado e alterar o estilo da fonte em
  C# em alguns passos fáceis.
draft: false
keywords:
...
- change font style c#
language: pt
og_description: Combine negrito e itálico em HTML usando C#. Este guia mostra como
  modificar o estilo de fonte do HTML, salvar o HTML modificado e alterar o estilo
  de fonte em C# rapidamente.
og_title: Combine negrito e itálico em HTML com C# – Passo a passo
tags:
- C#
- Aspose.Html
- HTML manipulation
title: Combine negrito e itálico em HTML com C# – Guia completo
url: /pt/net/html-document-manipulation/combine-bold-and-italic-in-html-with-c-complete-guide/
---
...
Já precisou **combinar negrito e itálico** em um trecho HTML, mas não sabia como fazer isso programaticamente? Você não está sozinho—muitos desenvolvedores enfrentam esse obstáculo ao gerar e‑mails ou relatórios dinâmicos. A boa notícia é que, com algumas linhas de C# e a biblioteca Aspose.HTML, você pode aplicar um estilo de fonte combinado (negrito e itálico) a qualquer documento e então **salvar o HTML modificado** para uso posterior.

Neste tutorial vamos percorrer todo o processo: carregar um pequeno fragmento HTML, **modificar o estilo de fonte HTML**, aplicar o efeito **combine bold and italic**, e finalmente **salvar o HTML modificado** no disco. Ao final, você saberá exatamente como **change font style C#**‑wise sem precisar vasculhar documentação obscura.

## What You’ll Need

- .NET 6 ou superior (o código também funciona no .NET Core)  
...
Nenhuma outra dependência. Se já tem um projeto, basta adicionar o pacote NuGet e está pronto para usar.
...
*Texto alternativo da imagem: combinar negrito e itálico*
