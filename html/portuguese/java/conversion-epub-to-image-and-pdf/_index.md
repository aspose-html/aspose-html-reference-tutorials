...
### [Converter EPUB para PNG em Java – Definir Dimensões da Imagem](./convert-epub-to-png-in-java-set-image-dimensions/)
Aprenda a converter EPUB para PNG em Java definindo a largura e altura das imagens geradas.
