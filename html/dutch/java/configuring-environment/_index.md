...
### [Hoe Sandbox te gebruiken – User‑agent instellen en viewport‑grootte ophalen](./how-to-use-sandbox-set-user-agent-get-viewport-size/)
Leer hoe je in Aspose.HTML voor Java de sandbox configureert om een user‑agent in te stellen en de viewport‑grootte te verkrijgen.
