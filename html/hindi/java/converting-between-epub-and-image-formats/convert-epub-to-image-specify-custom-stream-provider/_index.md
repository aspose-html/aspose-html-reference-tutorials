...
### Q1: क्या मैं Aspose.HTML for Java को मुफ्त में उपयोग कर सकता हूँ?

A1: Aspose.HTML for Java एक व्यावसायिक लाइब्रेरी है, लेकिन आप इसकी सुविधाओं को एक [मुफ्त ट्रायल](https://releases.aspose.com/html/java) के साथ आज़मा सकते हैं।

### Q2: क्या Aspose.HTML for Java के लिए कोई दस्तावेज़ उपलब्ध है?

A2: हाँ, आप विस्तृत दस्तावेज़ीकरण [यहाँ](https://reference.aspose.com/html/java/) पा सकते हैं।

### Q3: मैं Aspose.HTML for Java के लिए अस्थायी लाइसेंस कैसे प्राप्त करूँ?

A3: आप एक अस्थायी लाइसेंस [यहाँ](https://purchase.aspose.com/temporary-license/) से प्राप्त कर सकते हैं।

### Q4: Aspose.HTML for Java के लिए समर्थन कहाँ मिल सकता है?

A4: समर्थन और समुदाय चर्चा के लिए [Aspose फ़ोरम](https://forum.aspose.com/) पर जाएँ।

### Q5: क्या मैं EPUB फ़ाइलों को अन्य इमेज फ़ॉर्मेट में बदल सकता हूँ?

A5: हाँ, `ImageSaveOptions` को समायोजित करके आउटपुट फ़ॉर्मेट को कस्टमाइज़ कर सकते हैं। `ImageFormat` को अपनी इच्छित फ़ॉर्मेट (जैसे PNG या GIF) में बदलें।
