...
### [Top‑level await‑exempel – Använd await‑fördröjning i JavaScript](./top-level-await-example-using-await-delay-in-javascript/)
Lär dig hur du använder top‑level await med en fördröjningsfunktion i JavaScript.
