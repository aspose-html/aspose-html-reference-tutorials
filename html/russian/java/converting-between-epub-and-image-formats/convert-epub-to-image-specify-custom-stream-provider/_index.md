...
### Вопрос 1: Можно ли использовать Aspose.HTML for Java бесплатно?

A1: Aspose.HTML for Java — коммерческая библиотека, но вы можете ознакомиться с её возможностями, используя [бесплатную пробную версию](https://releases.aspose.com/html/java).

### Вопрос 2: Есть ли документация по Aspose.HTML for Java?

A2: Да, полную документацию можно найти [здесь](https://reference.aspose.com/html/java/).

### Вопрос 3: Как получить временную лицензию для Aspose.HTML for Java?

A3: Временную лицензию можно получить [здесь](https://purchase.aspose.com/temporary-license/).

### Вопрос 4: Где можно получить поддержку по Aspose.HTML for Java?

A4: Для поддержки и обсуждений сообщества посетите [форумы Aspose](https://forum.aspose.com/).

### Вопрос 5: Можно ли конвертировать EPUB в другие форматы изображений?

A5: Да, вы можете настроить формат вывода, изменив `ImageSaveOptions`. Установите `ImageFormat` на нужный вам формат, например PNG или GIF.
