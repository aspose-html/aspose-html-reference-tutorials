...
category: general
date: 2026-04-01
description: Объедините жирный и курсивный шрифт в HTML с помощью C#. Узнайте, как
  изменить стиль шрифта в HTML, сохранить изменённый HTML и изменить стиль шрифта
  в C# за несколько простых шагов.
draft: false
keywords:
...
- change font style c#
language: ru
og_description: Объедините жирный и курсивный шрифт в HTML с помощью C#. Это руководство
  показывает, как изменить стиль шрифта в HTML, сохранить изменённый HTML и быстро
  изменить стиль шрифта с помощью C#.
og_title: Объединяем жирный и курсив в HTML с C# – пошагово
tags:
- C#
- Aspose.Html
- HTML manipulation
title: Объединяем жирный и курсив в HTML с помощью C# – Полное руководство
url: /ru/net/html-document-manipulation/combine-bold-and-italic-in-html-with-c-complete-guide/
---
...
Когда‑то вам нужно было **объединить полужирный и курсивный** шрифт в HTML‑фрагменте, но вы не знали, как сделать это программно? Вы не одиноки — многие разработчики сталкиваются с этой проблемой при генерации динамических писем или отчётов. Хорошая новость: с несколькими строками C# и библиотекой Aspose.HTML вы можете применить комбинированный полужирный‑и‑курсивный стиль к любому документу, а затем **сохранить изменённый HTML** для дальнейшего использования.

В этом руководстве мы пройдём весь процесс: загрузим небольшой HTML‑фрагмент, **изменим стиль шрифта в HTML**, применим эффект **combine bold and italic**, и, наконец, **сохраним изменённый HTML** на диск. К концу вы точно будете знать, как **change font style C#**‑wise без необходимости копаться в непонятной документации.

## What You’ll Need

- .NET 6 или новее (код работает и на .NET Core)  
- Aspose.HTML for .NET — его можно установить через NuGet (`Install-Package Aspose.HTML`)  
- Текстовый редактор или IDE (Visual Studio, VS Code, Rider — что вам удобно)  

Больше никаких зависимостей. Если у вас уже есть проект, просто добавьте пакет NuGet — и всё готово.
...
*Текст alt‑изображения: combine bold and italic*
