...
### [Как включить сглаживание при конвертации HTML‑в‑PDF в C#](./how-to-enable-antialiasing-for-html-to-pdf-in-c/)
Узнайте, как активировать сглаживание при рендеринге HTML в PDF с помощью Aspose.HTML для .NET в C#.
