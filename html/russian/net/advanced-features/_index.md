...
### [Пользовательский обработчик ресурсов в Aspose HTML – Руководство по сохранению в поток](./custom-resource-handler-in-aspose-html-save-to-stream-guide/)
Узнайте, как создать пользовательский обработчик ресурсов в Aspose HTML и сохранять данные напрямую в поток.
