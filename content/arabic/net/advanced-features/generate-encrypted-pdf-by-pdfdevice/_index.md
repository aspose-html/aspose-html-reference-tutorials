...
```
 ...
 في هذه الخطوة الأخيرة نستخدم`RenderTo` طريقة تحويل مستند HTML إلى PDF. نحن نمرر`PdfDevice` المثيل ومسار ملف الإخراج المطلوب. سيتم تحويل محتوى HTML إلى مستند PDF بالإعدادات المحددة.
