...
في هذا البرنامج التعليمي، سنرشدك خلال عملية ضبط حجم صفحة XPS باستخدام Aspose.HTML لـ Java. تسمح لك هذه المكتبة القوية بمعالجة مستندات HTML وتقديمها إلى تنسيقات مختلفة، بما في ذلك XPS. يعد ضبط حجم الصفحة أمرًا ضروريًا عندما تحتاج إلى التحكم في أبعاد الإخراج لمستند XPS الخاص بك.
